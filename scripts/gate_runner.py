...
MANDATORY_AUTHORITY_GATES: tuple[Gate, ...] = (
    Gate(
        gate_id="canonical.floor-source-evidence",
        order=64,
        description="Bind each measured floor leaf to independently parsed CODATA source-row evidence.",
        tiers=("canonical", "doctor", "pr", "full", "nightly", "stop"),
        phase="provenance",
        command=("{python}", "scripts/codata_floor_evidence_gate.py"),
        self_test=(
            "{python}",
        ...
        inputs=(
            ...
            "crates/units/data/codata_2018_floor_facts.tsv",
            "crates/units/data/codata_2018_floor_evidence_receipt.json",
            "crates/units/src/fundamentals.rs",
            "crates/units/src/physics_floor.rs",
            "crates/units/src/physics_floor_source_evidence.rs",
