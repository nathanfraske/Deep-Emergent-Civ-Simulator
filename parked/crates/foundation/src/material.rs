...
/// Compatibility re-exports for callers that still use
/// `civsim_foundation::material`. Canonical ownership is now the world crate's
/// geology module; these names are the same types, not wrappers or copies.
pub use civsim_world::geology::{EarthworkField, GeodynamicColumn, GeodynamicField};
...
"#;
    ...
    #[test]
    fn geology_names_remain_exact_world_type_reexports() {
        fn takes_world_earthwork(_: civsim_world::geology::EarthworkField) {}
        fn takes_world_geodynamics(_: civsim_world::geology::GeodynamicField) {}
        fn takes_world_column(_: civsim_world::geology::GeodynamicColumn) {}

        takes_world_earthwork(EarthworkField::new());
        takes_world_geodynamics(GeodynamicField::new());
        takes_world_column(GeodynamicColumn::default());
    }
