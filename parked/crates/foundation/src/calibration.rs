...
/// Compatibility export for the legacy reserved-value loader. Canonical code
/// imports the taxonomy from `civsim_ledger` directly.
pub use civsim_ledger::Provenance;
