...
- Tool `floor_admission`: renders the repository-owned accounting inventory and admission state: tier, provenance mark, derivation ancestry, exhaustion receipt, Buckingham-Pi budget, Gap Law and Residual Law obligations, and admitted or refused status. It exposes no editable value field.
...
**Floor-admission panel.** Shows the complete four-tier by seven-mark accounting inventory and every admission or refusal receipt. For every non-derived floor candidate at every tier it shows derivation attempts, the Buckingham-Pi budget, Gap Law evidence, Residual Law evidence, and residual-slot identity. Evidence custody is visible but cannot switch a candidate to admitted. The panel has no editable magnitude field.
