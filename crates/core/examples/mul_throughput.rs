...
//! (including vector length and operands) to produce a result for demonstration and testing only, and
...
//! accepts only the sealed absolute floor and refuses incomplete closure; see docs/QUARANTINE.md.
//!
