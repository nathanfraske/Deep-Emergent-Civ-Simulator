...
fn repository_frontier_reports_the_derived_seed_and_completed_local_profile_protocol() {
    ...
    assert_eq!(frontier.current_descriptor_role_count, 107);
    assert_eq!(frontier.current_relation_target_count, 125);
    assert_eq!(frontier.current_constraint_law_count, 5);
