...
- **WHAT IS LIVE ON MAIN NOW (FOUR arcs merged overnight, each pin-verified by me):** aging (#113, `0c11e77`), the belief-subject hybrid key plus the affordance composer (#115, `0c2c7aa`, the one sanctioned re-pin: `full` -> `1db633b3`), PREDATION OBSERVABLE (#117, `0cee3a0`, a predator wounds the pursued prey, byte-neutral), and the CREATURES-REACT CAPACITY (#118, `373e0d8`, a mind-less creature perceives a being and moves toward or away by a selection-lifted freely-signed weight, byte-neutral, with a watchable demo proving hunter and fleer). The current canonical pins are default `4bbf6b59`, full `1db633b3`, discovery `c9d5cc17`, viability `ad69f2bf`, all four unchanged by predation and creatures-react. Still on branches (feature-complete or in progress): the day-night surface (feature-complete, watchable) and the Nernst (Agent C, #112), the creature reproduction/behaviour-selection slice that makes the creature reaction EMERGE and visible (Agent B, #120, just opened), and the stroke-rate substrate (Agent A, #119, frame-blind). With the creature-selection slice, `full --creatures` (creatures + predation + reaction) becomes the integrated living-world scenario, the capstone.
