...
- **WHAT IS LIVE ON MAIN NOW (three arcs merged overnight, each pin-verified by me):** aging (#113, `0c11e77`), the belief-subject hybrid key plus the affordance composer (#115, `0c2c7aa`, the one sanctioned re-pin: `full` -> `1db633b3`), and PREDATION OBSERVABLE (#117, `0cee3a0`, a predator wounds the pursued prey, byte-neutral, the four pins unchanged). The current canonical pins are default `4bbf6b59`, full `1db633b3`, discovery `c9d5cc17`, viability `ad69f2bf`. Still on branches (feature-complete or in progress): the day-night surface and Nernst (Agent C, #112), the creatures-react being-percept (Agent B, #118, scaffold landed), and the stroke-rate substrate (Agent A, #119, frame-blind).
