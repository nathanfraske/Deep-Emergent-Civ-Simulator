...
- 2026-07-29  A compile-once complete-binary scheduler and resource profiler cut the measured PR route from 651.68 to 227.83 seconds while retaining a sparse Cargo-native serial cross-check -> `docs/working/VERIFICATION_PERFORMANCE.md`
- 2026-07-29  Automatic CI now runs only Stone 0 and canonical planet gates; the parked compatibility build is an explicit manual maintenance workflow and cannot supply readiness evidence -> `.github/workflows/`
...
- 2026-07-28  V10 remains distinct while current transcripts select V11; run receipt v14 carries the 125-artifact Stage 1 frontier -> `crates/planet/src/canonical/transcript.rs`
...
- 2026-07-28  Direct CLI tests pin exit 2, six events, receipt v14, schema major 11, the exact 125-artifact frontier, immutable views, and argument rejection -> `crates/planet/tests/canonical_cli.rs`
