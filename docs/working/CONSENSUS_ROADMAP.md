...
- 2026-07-28  Optimized exact tests and shared helper-binary profile cut all-target validation to 370.91 seconds and the warm confining receipt to 49.1 seconds -> `Cargo.toml`, `justfile`
