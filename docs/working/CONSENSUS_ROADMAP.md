...
- 2026-07-27  Action-bound conditional applicability closure landed; semantic premise admission, physical family closure, and irreducible evidence remain -> `TODOS.md` P-PHYSICAL-LAW-PREMISE-AUTHORITY
...
- 2026-07-26  Direct CLI tests pin exit 2, six events, receipt v13, schema major 10, census v4, structure v2, species analysis v4, the exact root and vocabulary frontier, immutable typed views, repeatability, readiness aliasing, and rejection of world, profile, and seed arguments -> `crates/planet/tests/canonical_cli.rs`
