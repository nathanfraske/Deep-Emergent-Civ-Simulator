...
- 2026-07-26  Formula power grammar is paired and dense basis work is capped before allocation; broader kernels and table policy stay blocked -> `docs/working/PR215_LIVE_SOURCE_AUDIT.md`
...
- 2026-07-26  Species derivation analysis v4 runs the live registry under its v5 watchdog and serializes the exact root census, 0/4/0 vocabulary partition, honest scientific refusal, zero members, zero support, no value, and no residual slot -> `crates/planet/src/canonical/stellar_birth_species/authority_analysis/`
...
- 2026-07-26  V9 remains distinct while current transcripts select V10; run receipt v12 carries the Stage 1 frontier, census v4, structure v2, species analysis v4, physical vocabulary v1, and v5 root agreement or refusal -> `crates/planet/src/canonical/transcript.rs`
...
- 2026-07-20  `civsim-planet-substrate` privately owns the retained star, system, planet, geodynamics, deep-time, moon, and flexure modules with 374 passing tests -> `crates/planet-substrate/src/lib.rs`
...
- 2026-07-25  Stone 0 uses rooted isolated Python, scrubbed execution, wrapper receipts, and replay sentinels; native Windows fails closed through WSL -> `crates/stone0/src/lib.rs`
...
- 2026-07-25  Physical-floor v4 binds CODATA canary v2 and exact receipt custody before its value-opaque capability projects execution magnitudes -> `crates/units/src/physics_floor.rs`
...
- 2026-07-26  Direct CLI tests pin exit 2, six events, receipt v12, schema major 10, census v4, structure v2, species analysis v4, the exact root and vocabulary frontier, immutable typed views, repeatability, readiness aliasing, and rejection of world, profile, and seed arguments -> `crates/planet/tests/canonical_cli.rs`
...
- 2026-07-26  Two direct receipt v12 and transcript-major-10 runs are byte-identical at 383,680 stdout bytes and SHA-256 `02c4e48c5f56a54ed1429bea82d96dffdd38722d7ed23456ef0b64fa070153b5`; the added bytes carry the exact vocabulary partition and per-root admission census while the physical outcome remains the same refusal -> `docs/working/STELLAR_BIRTH_MEASURE_CONTRACT.md`
...
- 2026-07-20  One declarative inventory, now 30 gates, drives CI, Stone 0, Stop, Just, Make, PowerShell, local CI, and tracked pre-push routes -> `scripts/gates.toml`, `scripts/githooks/pre-push`
...
- 2026-07-25  No-argument, `run-derived`, and `--readiness` entrypoints execute one canonical floor-only run and emit the same receipt; none is a bypass -> `crates/planet/src/bin/run_planet.rs`
