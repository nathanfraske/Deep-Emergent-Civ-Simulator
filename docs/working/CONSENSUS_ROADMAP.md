...
- 2026-07-28  Optimized exact test code and isolated sealed-fixture reuse cut planet all-target validation to 370.91 seconds and the full PR receipt to 1,076.19 seconds -> `Cargo.toml`, `crates/planet/src/canonical/stellar_birth_species/`
