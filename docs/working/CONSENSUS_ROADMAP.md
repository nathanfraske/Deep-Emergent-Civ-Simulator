...
- 2026-07-26  Species derivation analysis v6 runs under watchdog v7 and serializes the claim-scoped premise evidence beside the exact root census, 0/4/0 vocabulary partition, honest scientific refusal, zero members, zero species-support values, and no residual slot -> `crates/planet/src/canonical/stellar_birth_species/authority_analysis/`
