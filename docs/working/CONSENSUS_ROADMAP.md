...
- 2026-07-19  Disk-arc P0/P1 audit repairs -> #210 (`claude/abiotic-field-registry-lmqbqd`). All 4 P0 typed-contract defects + P1 repaired, byte-neutral, pins bit-exact. #211 landed, so rebased onto main and running the hardened `ci_local.sh` before push. Detail in `HANDOFFS.md` top entry.
