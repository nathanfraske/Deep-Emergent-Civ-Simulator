...
| `stellar_birth_species.rs` | Exact complete-support verification and mean-particle-mass reduction over sealed candidates. | 6 unit tests, including permutation and unfamiliar-state behavior. | Keep cohesive until a real repository authority and support resolver exist. Production currently returns no support. |
