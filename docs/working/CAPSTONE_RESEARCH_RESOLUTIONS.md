...
- Integrity checks (done): eps_M = 1.22*eps and eta = 1/2 in Eq. (82) reproduces Eq. (83)'s intercept (-6.72 + 0.21 = -6.51); back-solving the slopes gives delta_ov ~ 0.85*eps^(1/4), spacing 2*delta_ov ~ 1.71*eps^(1/4) at overlap, consistent with Quillen's independent `delta <~ 2*m^(1/4)`. The delta_ov value is algebraically reconstructed, so VERIFY against their Eq. (61) in the arXiv PDF.
